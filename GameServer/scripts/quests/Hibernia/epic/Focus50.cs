...
namespace DOL.GS.Quests.Hibernia
{
	public class Focus_50 : BaseQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			GreenMaw_key = GameServer.Database.FindObjectByKey<DbItemTemplate>("GreenMaw_key");
			if (GreenMaw_key == null)
			{
				if (log.IsWarnEnabled)
					log.Warn("Could not find GreenMaw's Key , creating it ...");
				GreenMaw_key = new DbItemTemplate();
...
// end item			
			...
			if (RangerEpicBoots == null)
			{
				...
				RangerEpicBoots = new DbItemTemplate();
...
//end item
			...
			if (RangerEpicHelm == null)
			{
				...
				RangerEpicHelm = new DbItemTemplate();
...
//end item
			...
			if (RangerEpicGloves == null)
			{
				...
				RangerEpicGloves = new DbItemTemplate();
			...
			if (RangerEpicVest == null)
			{
				...
				RangerEpicVest = new DbItemTemplate();
			...
			if (RangerEpicLegs == null)
			{
				...
				RangerEpicLegs = new DbItemTemplate();
			...
			if (RangerEpicArms == null)
			{
				...
				RangerEpicArms = new DbItemTemplate();
...
//Hero Epic Sleeves End
			HeroEpicBoots = GameServer.Database.FindObjectByKey<DbItemTemplate>("HeroEpicBoots");
			if (HeroEpicBoots == null)
			{
				if (log.IsWarnEnabled)
					log.Warn("Could not find Heros Epic Boots , creating it ...");
				HeroEpicBoots = new DbItemTemplate();
...
//end item
			...
			if (HeroEpicHelm == null)
			{
				...
				HeroEpicHelm = new DbItemTemplate();
...
//end item
			...
			if (HeroEpicGloves == null)
			{
				...
				HeroEpicGloves = new DbItemTemplate();
			...
			if (HeroEpicVest == null)
			{
				...
				HeroEpicVest = new DbItemTemplate();
			...
			if (HeroEpicLegs == null)
			{
				...
				HeroEpicLegs = new DbItemTemplate();
			...
			if (HeroEpicArms == null)
			{
				...
				HeroEpicArms = new DbItemTemplate();
			...
			WardenEpicBoots = GameServer.Database.FindObjectByKey<DbItemTemplate>("WardenEpicBoots");
			if (WardenEpicBoots == null)
			{
				if (log.IsWarnEnabled)
					log.Warn("Could not find Warden Epic Boots , creating it ...");
				WardenEpicBoots = new DbItemTemplate();
...
//end item
			...
			if (WardenEpicHelm == null)
			{
				...
				WardenEpicHelm = new DbItemTemplate();
...
//end item
			...
			if (WardenEpicGloves == null)
			{
				...
				WardenEpicGloves = new DbItemTemplate();
			...
			if (WardenEpicVest == null)
			{
				...
				WardenEpicVest = new DbItemTemplate();
			...
			if (WardenEpicLegs == null)
			{
				...
				WardenEpicLegs = new DbItemTemplate();
			...
			if (WardenEpicArms == null)
			{
				...
				WardenEpicArms = new DbItemTemplate();
			...
			EldritchEpicBoots = GameServer.Database.FindObjectByKey<DbItemTemplate>("EldritchEpicBoots");
			if (EldritchEpicBoots == null)
			{
				if (log.IsWarnEnabled)
					log.Warn("Could not find Eldritch Epic Boots , creating it ...");
				EldritchEpicBoots = new DbItemTemplate();
...
//end item
			...
			if (EldritchEpicHelm == null)
			{
				...
				EldritchEpicHelm = new DbItemTemplate();
...
//end item
			...
			if (EldritchEpicGloves == null)
			{
				...
				EldritchEpicGloves = new DbItemTemplate();
			...
			if (EldritchEpicVest == null)
			{
				...
				EldritchEpicVest = new DbItemTemplate();
			...
			if (EldritchEpicLegs == null)
			{
				...
				EldritchEpicLegs = new DbItemTemplate();
			...
			if (EldritchEpicArms == null)
			{
				...
				EldritchEpicArms = new DbItemTemplate();
...
//Hero Epic Sleeves End
            ...
            MaulerHibEpicBoots = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicBoots");
            MaulerHibEpicHelm = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicHelm");
            MaulerHibEpicGloves = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicGloves");
            MaulerHibEpicVest = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicVest");
            MaulerHibEpicLegs = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicLegs");
            MaulerHibEpicArms = GameServer.Database.FindObjectByKey<DbItemTemplate>("MaulerHibEpicArms");
